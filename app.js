...
const SEED_RANDOS = [
  ...
  // ── 5ᵉ série : MASSIF DU MONT-BLANC (2h–2h30 de route) ──
  {nom:"Lac Blanc (Aiguilles Rouges)",massif:"Mont-Blanc",denivele:700,distance_km:9,duree_h:4.5,temps_voiture_min:140,difficulte:"Moyen",paysage:"Lac",depart:"La Flégère (Chamonix)"},
  {nom:"Les Lacs des Chéserys",massif:"Mont-Blanc",denivele:600,distance_km:8,duree_h:4,temps_voiture_min:140,difficulte:"Moyen",paysage:"Lac",depart:"Tré-le-Champ (Argentière)"},
  {nom:"Le Brévent",massif:"Mont-Blanc",denivele:850,distance_km:11,duree_h:5,temps_voiture_min:140,difficulte:"Difficile",paysage:"Panorama",depart:"Planpraz (Chamonix)"},
  {nom:"Lac Cornu & Lacs Noirs",massif:"Mont-Blanc",denivele:900,distance_km:11,duree_h:5.5,temps_voiture_min:140,difficulte:"Difficile",paysage:"Lac",depart:"La Flégère (Chamonix)"},
  {nom:"Aiguillette des Posettes",massif:"Mont-Blanc",denivele:700,distance_km:10,duree_h:4.5,temps_voiture_min:145,difficulte:"Moyen",paysage:"Panorama",depart:"Le Tour (Chamonix)"},
  {nom:"Le Montenvers & Mer de Glace",massif:"Mont-Blanc",denivele:850,distance_km:10,duree_h:5,temps_voiture_min:140,difficulte:"Difficile",paysage:"Glacier",depart:"Chamonix"},
  {nom:"Le Mont Buet (3096 m)",massif:"Mont-Blanc",denivele:1700,distance_km:17,duree_h:9,temps_voiture_min:150,difficulte:"Très difficile",paysage:"Sommet",depart:"Le Buet (Vallorcine)"},
  {nom:"Refuge de Moëde-Anterne & Lac de Pormenaz",massif:"Mont-Blanc",denivele:1000,distance_km:13,duree_h:6,temps_voiture_min:135,difficulte:"Difficile",paysage:"Lac",depart:"Plaine Joux (Passy)"},
  {nom:"Lac Vert de Passy",massif:"Mont-Blanc",denivele:120,distance_km:5,duree_h:2,temps_voiture_min:130,difficulte:"Facile",paysage:"Lac",depart:"Passy"},
  {nom:"Le Prarion",massif:"Mont-Blanc",denivele:800,distance_km:11,duree_h:4.5,temps_voiture_min:135,difficulte:"Moyen",paysage:"Panorama",depart:"Les Houches"},
  {nom:"L'Aiguillette des Houches",massif:"Mont-Blanc",denivele:750,distance_km:11,duree_h:5,temps_voiture_min:135,difficulte:"Moyen",paysage:"Panorama",depart:"Les Houches (Coupeau)"},
  {nom:"Le Mont Joly",massif:"Mont-Blanc",denivele:900,distance_km:11,duree_h:5,temps_voiture_min:130,difficulte:"Difficile",paysage:"Sommet",depart:"Le Bettex (Saint-Gervais)"},
  {nom:"Le Christomet",massif:"Mont-Blanc",denivele:550,distance_km:9,duree_h:3.5,temps_voiture_min:130,difficulte:"Moyen",paysage:"Panorama",depart:"Megève"},
  {nom:"Mont d'Arbois & Croix des Salles",massif:"Mont-Blanc",denivele:500,distance_km:9,duree_h:3.5,temps_voiture_min:130,difficulte:"Facile",paysage:"Panorama",depart:"Megève"},
  {nom:"Le Désert de Platé",massif:"Mont-Blanc",denivele:900,distance_km:12,duree_h:5.5,temps_voiture_min:140,difficulte:"Difficile",paysage:"Plateau",depart:"Flaine"},
  // ── 5ᵉ série : CHABLAIS (complément) ──
  {nom:"Le Mont de Grange",massif:"Chablais",denivele:1250,distance_km:13,duree_h:6.5,temps_voiture_min:135,difficulte:"Difficile",paysage:"Sommet",depart:"Abondance"},
  {nom:"Lac de Joux Plane",massif:"Chablais",denivele:300,distance_km:7,duree_h:2.5,temps_voiture_min:125,difficulte:"Facile",paysage:"Lac",depart:"Morzine"},
  {nom:"Le Mont Ouzon",massif:"Chablais",denivele:900,distance_km:9,duree_h:5,temps_voiture_min:120,difficulte:"Difficile",paysage:"Sommet",depart:"Bellevaux"},
  {nom:"Lac de Vallon",massif:"Chablais",denivele:200,distance_km:6,duree_h:2,temps_voiture_min:120,difficulte:"Facile",paysage:"Lac",depart:"Bellevaux"},
  {nom:"Pointe de Nantaux",massif:"Chablais",denivele:1300,distance_km:11,duree_h:6,temps_voiture_min:125,difficulte:"Difficile",paysage:"Sommet",depart:"Morzine"},
  {nom:"Les Hauts Forts",massif:"Chablais",denivele:1100,distance_km:12,duree_h:6,temps_voiture_min:130,difficulte:"Difficile",paysage:"Sommet",depart:"Avoriaz"},
  {nom:"Pointe d'Uble",massif:"Chablais",denivele:600,distance_km:8,duree_h:3.5,temps_voiture_min:115,difficulte:"Moyen",paysage:"Panorama",depart:"Habère-Poche"},
  // ── 6ᵉ série : difficiles du côté de BONNEVILLE (massif du Bargy / Bornes-Faucigny) ──
  {nom:"Le Grand Bargy",massif:"Bornes",denivele:1250,distance_km:12,duree_h:6.5,temps_voiture_min:100,difficulte:"Difficile",paysage:"Sommet",depart:"Le Reposoir"},
  {nom:"Le Petit Bargy",massif:"Bornes",denivele:1100,distance_km:11,duree_h:6,temps_voiture_min:100,difficulte:"Difficile",paysage:"Sommet",depart:"Le Reposoir"},
  {nom:"La Pointe du Midi (Bargy)",massif:"Bornes",denivele:1150,distance_km:11,duree_h:6,temps_voiture_min:95,difficulte:"Difficile",paysage:"Sommet",depart:"Mont-Saxonnex"},
  {nom:"La Pointe Blanche du Bargy",massif:"Bornes",denivele:1000,distance_km:10,duree_h:5.5,temps_voiture_min:95,difficulte:"Difficile",paysage:"Sommet",depart:"Mont-Saxonnex"},
  {nom:"La Pointe de Balafrasse",massif:"Bornes",denivele:1050,distance_km:11,duree_h:6,temps_voiture_min:100,difficulte:"Difficile",paysage:"Sommet",depart:"Le Reposoir"},
  {nom:"L'Aiguille Verte de Bargy",massif:"Bornes",denivele:1150,distance_km:11,duree_h:6.5,temps_voiture_min:100,difficulte:"Difficile",paysage:"Sommet",depart:"Le Reposoir"},
  {nom:"La Pointe d'Areu",massif:"Aravis",denivele:1200,distance_km:12,duree_h:6.5,temps_voiture_min:105,difficulte:"Difficile",paysage:"Sommet",depart:"Romme-sur-Cluses"},
  {nom:"Le Jallouvre par le Lac de Lessy",massif:"Bornes",denivele:1150,distance_km:13,duree_h:6.5,temps_voiture_min:95,difficulte:"Difficile",paysage:"Sommet",depart:"Le Petit-Bornand"},
  {nom:"La Pointe d'Andey par la face nord",massif:"Bornes",denivele:1000,distance_km:10,duree_h:5.5,temps_voiture_min:90,difficulte:"Difficile",paysage:"Panorama",depart:"Bonneville (Ayze)"},
  // ── 7ᵉ série : massif du BEAUFORTAIN (Beaufort / Arêches / Roselend, 2h–2h30) ──
  {nom:"Lac de Roselend & Col du Pré",massif:"Beaufortain",denivele:400,distance_km:9,duree_h:3.5,temps_voiture_min:130,difficulte:"Facile",paysage:"Lac",depart:"Arêches"},
  {nom:"La Roche Parstire",massif:"Beaufortain",denivele:600,distance_km:8,duree_h:3.5,temps_voiture_min:140,difficulte:"Moyen",paysage:"Panorama",depart:"Cormet de Roselend"},
  {nom:"La Légette du Mirantin",massif:"Beaufortain",denivele:800,distance_km:10,duree_h:4.5,temps_voiture_min:130,difficulte:"Moyen",paysage:"Panorama",depart:"Arêches"},
  {nom:"Lac de la Gittaz",massif:"Beaufortain",denivele:250,distance_km:7,duree_h:2.5,temps_voiture_min:140,difficulte:"Facile",paysage:"Lac",depart:"Hauteluce"},
  {nom:"Le Grand Mont d'Arêches",massif:"Beaufortain",denivele:1000,distance_km:11,duree_h:5.5,temps_voiture_min:130,difficulte:"Difficile",paysage:"Sommet",depart:"Arêches (Le Planay)"},
  {nom:"Le Crêt du Rey",massif:"Beaufortain",denivele:900,distance_km:11,duree_h:5,temps_voiture_min:130,difficulte:"Difficile",paysage:"Sommet",depart:"Le Planay"},
  {nom:"Le Mont Mirantin",massif:"Beaufortain",denivele:1300,distance_km:13,duree_h:6.5,temps_voiture_min:125,difficulte:"Difficile",paysage:"Sommet",depart:"Le Bersend (Beaufort)"},
  {nom:"Refuge de Presset & Col du Grand Fond",massif:"Beaufortain",denivele:900,distance_km:12,duree_h:6,temps_voiture_min:145,difficulte:"Difficile",paysage:"Lac",depart:"Cormet de Roselend"},
  // ── 7ᵉ série : massif de BELLEDONNE (Chamrousse / Sept-Laux / Freydières, ~2h30) ──
  {nom:"La Croix de Chamrousse & Lacs Robert",massif:"Belledonne",denivele:500,distance_km:9,duree_h:3.5,temps_voiture_min:150,difficulte:"Facile",paysage:"Lac",depart:"Chamrousse"},
  {nom:"Le Grand Rocher",massif:"Belledonne",denivele:600,distance_km:8,duree_h:3.5,temps_voiture_min:150,difficulte:"Moyen",paysage:"Panorama",depart:"Prapoutel"},
  {nom:"Les Lacs des Sept Laux",massif:"Belledonne",denivele:800,distance_km:11,duree_h:5,temps_voiture_min:150,difficulte:"Moyen",paysage:"Lac",depart:"Fond de France (Le Pleynet)"},
  {nom:"Le Lac Blanc & Lac de Crop",massif:"Belledonne",denivele:700,distance_km:10,duree_h:4.5,temps_voiture_min:150,difficulte:"Moyen",paysage:"Lac",depart:"Freydières"},
  {nom:"Le Lac du Crozet",massif:"Belledonne",denivele:700,distance_km:9,duree_h:4,temps_voiture_min:150,difficulte:"Moyen",paysage:"Lac",depart:"La Combe de Lancey"},
  {nom:"Le Grand Colon",massif:"Belledonne",denivele:1050,distance_km:12,duree_h:6,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Freydières"},
  {nom:"Le Pic de la Belle Étoile",massif:"Belledonne",denivele:1200,distance_km:13,duree_h:6.5,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Le Pleynet"},
  {nom:"Le Rocher Blanc",massif:"Belledonne",denivele:1200,distance_km:14,duree_h:7,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Fond de France"},
  // ── 8ᵉ série : difficiles BEAUFORTAIN & BELLEDONNE ──
  {nom:"L'Aiguille du Grand Fond",massif:"Beaufortain",denivele:1100,distance_km:13,duree_h:6.5,temps_voiture_min:145,difficulte:"Difficile",paysage:"Sommet",depart:"Cormet de Roselend"},
  {nom:"Le Mont Coin",massif:"Beaufortain",denivele:1000,distance_km:12,duree_h:5.5,temps_voiture_min:145,difficulte:"Difficile",paysage:"Sommet",depart:"Lac de Roselend"},
  {nom:"Le Roignais",massif:"Beaufortain",denivele:1300,distance_km:14,duree_h:7,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Les Chapieux"},
  {nom:"La Pierra Menta (Brèche de Roselend)",massif:"Beaufortain",denivele:1100,distance_km:12,duree_h:6,temps_voiture_min:135,difficulte:"Difficile",paysage:"Sommet",depart:"Arêches"},
  {nom:"La Roche Pourrie",massif:"Beaufortain",denivele:1050,distance_km:11,duree_h:5.5,temps_voiture_min:140,difficulte:"Difficile",paysage:"Sommet",depart:"Granier"},
  {nom:"La Pointe de la Grande Journée",massif:"Beaufortain",denivele:950,distance_km:10,duree_h:5,temps_voiture_min:130,difficulte:"Difficile",paysage:"Sommet",depart:"Molliessoulaz (Beaufort)"},
  {nom:"La Croix de Belledonne (2926 m)",massif:"Belledonne",denivele:1500,distance_km:15,duree_h:8,temps_voiture_min:150,difficulte:"Très difficile",paysage:"Sommet",depart:"Freydières"},
  {nom:"La Grande Lance de Domène",massif:"Belledonne",denivele:1400,distance_km:14,duree_h:7.5,temps_voiture_min:150,difficulte:"Très difficile",paysage:"Sommet",depart:"Freydières"},
  {nom:"La Cime de la Jasse",massif:"Belledonne",denivele:1200,distance_km:13,duree_h:6.5,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Freydières"},
  {nom:"La Dent du Pra",massif:"Belledonne",denivele:1250,distance_km:14,duree_h:7,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Le Pleynet"},
  {nom:"Le Rocher d'Arguille",massif:"Belledonne",denivele:1300,distance_km:14,duree_h:7,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Le Pleynet (Sept-Laux)"},
  {nom:"Le Puy Gris",massif:"Belledonne",denivele:1500,distance_km:15,duree_h:8,temps_voiture_min:150,difficulte:"Très difficile",paysage:"Sommet",depart:"Le Pleynet"},
  // ── 9ᵉ série : RANDOS 2 JOURS avec refuge (bivouac) — les plus belles ──
  {nom:"Lac & Refuge d'Anterne (Alfred Wills)",massif:"Mont-Blanc",denivele:1200,distance_km:22,duree_h:11,temps_voiture_min:140,difficulte:"Difficile",paysage:"Lac",depart:"Sixt-Fer-à-Cheval",jours:2,refuge:"Refuge Alfred Wills"},
  {nom:"Chalets & Cascades de Sales",massif:"Chablais",denivele:1100,distance_km:18,duree_h:9,temps_voiture_min:140,difficulte:"Moyen",paysage:"Cascade",depart:"Sixt-Fer-à-Cheval",jours:2,refuge:"Refuge de Sales"},
  {nom:"Refuge de la Vogealle & Bout du Monde",massif:"Chablais",denivele:1300,distance_km:20,duree_h:10,temps_voiture_min:140,difficulte:"Difficile",paysage:"Cirque",depart:"Sixt-Fer-à-Cheval",jours:2,refuge:"Refuge de la Vogealle"},
  {nom:"Pointe Percée & Refuge de Gramusset",massif:"Aravis",denivele:1500,distance_km:16,duree_h:10,temps_voiture_min:110,difficulte:"Très difficile",paysage:"Sommet",depart:"Le Grand-Bornand (Le Chinaillon)",jours:2,refuge:"Refuge de Gramusset"},
  {nom:"Refuge de Doran & Tête Pelouse",massif:"Aravis",denivele:1200,distance_km:18,duree_h:9,temps_voiture_min:120,difficulte:"Difficile",paysage:"Sommet",depart:"Sallanches",jours:2,refuge:"Refuge de Doran"},
  {nom:"La Tournette par le Refuge Blonay-Dufour",massif:"Annecy",denivele:1350,distance_km:14,duree_h:9,temps_voiture_min:90,difficulte:"Très difficile",paysage:"Sommet",depart:"Montmin (Chalet de l'Aulp)",jours:2,refuge:"Refuge de la Tournette (Blonay-Dufour)"},
  {nom:"Lac de Presset & Pierra Menta",massif:"Beaufortain",denivele:1200,distance_km:18,duree_h:10,temps_voiture_min:145,difficulte:"Difficile",paysage:"Lac",depart:"Cormet de Roselend",jours:2,refuge:"Refuge de Presset"},
  {nom:"Refuge Jean Collet & Lacs des Sept Laux",massif:"Belledonne",denivele:1300,distance_km:20,duree_h:10,temps_voiture_min:150,difficulte:"Difficile",paysage:"Lac",depart:"Fond de France",jours:2,refuge:"Refuge Jean Collet"},
  ...
  // ── 11ᵉ série : VERCORS (moyennes & difficiles, journée + bivouac, ≤ 2h30) ──
  {nom:"Le Grand Veymont (2341 m)",massif:"Vercors",denivele:1150,distance_km:16,duree_h:6.5,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Gresse-en-Vercors"},
  {nom:"La Grande Moucherolle",massif:"Vercors",denivele:900,distance_km:11,duree_h:5,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Villard-de-Lans (Côte 2000)"},
  {nom:"Le Cornafion",massif:"Vercors",denivele:1000,distance_km:12,duree_h:5.5,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Villard-de-Lans"},
  {nom:"La Grande Roche Saint-Michel & Rocher de la Balme",massif:"Vercors",denivele:900,distance_km:12,duree_h:5,temps_voiture_min:150,difficulte:"Difficile",paysage:"Panorama",depart:"Gresse-en-Vercors"},
  {nom:"Le Moucherotte",massif:"Vercors",denivele:700,distance_km:10,duree_h:4,temps_voiture_min:145,difficulte:"Moyen",paysage:"Panorama",depart:"Saint-Nizier-du-Moucherotte"},
  {nom:"Le Pic Saint-Michel",massif:"Vercors",denivele:600,distance_km:9,duree_h:3.5,temps_voiture_min:150,difficulte:"Moyen",paysage:"Panorama",depart:"Villard-de-Lans (Col de l'Arc)"},
  {nom:"La Molière & le Bec de l'Orient",massif:"Vercors",denivele:500,distance_km:11,duree_h:4,temps_voiture_min:145,difficulte:"Moyen",paysage:"Plateau",depart:"Autrans"},
  {nom:"Traversée des Hauts-Plateaux (Refuge de Chamousset)",massif:"Vercors",denivele:1100,distance_km:24,duree_h:11,temps_voiture_min:150,difficulte:"Difficile",paysage:"Plateau",depart:"Gresse-en-Vercors",jours:2,refuge:"Refuge de Chamousset"},
  {nom:"Le Grand Veymont par les Hauts-Plateaux (Refuge du Pré Peyret)",massif:"Vercors",denivele:1200,distance_km:26,duree_h:12,temps_voiture_min:150,difficulte:"Difficile",paysage:"Plateau",depart:"Corrençon-en-Vercors",jours:2,refuge:"Refuge du Pré Peyret"},
  {nom:"Réserve des Hauts-Plateaux : Jasse du Play & Font d'Urle",massif:"Vercors",denivele:800,distance_km:20,duree_h:9,temps_voiture_min:150,difficulte:"Moyen",paysage:"Plateau",depart:"Corrençon-en-Vercors",jours:2,refuge:"Refuge de la Jasse du Play"},
  // ── 12ᵉ série : CHAMBOTTE / ÉPINE / TERRES FROIDES / BORNES (moyennes & difficiles, ≤ 2h30) ──
  {nom:"Le Mont de la Chambotte & la Corniche",massif:"Chambotte",denivele:500,distance_km:9,duree_h:3.5,temps_voiture_min:75,difficulte:"Moyen",paysage:"Lac",depart:"Saint-Germain-la-Chambotte"},
  {nom:"Le Sapenay par les crêtes",massif:"Chambotte",denivele:600,distance_km:10,duree_h:4,temps_voiture_min:80,difficulte:"Moyen",paysage:"Panorama",depart:"Chindrieux"},
  {nom:"La Chambotte – Grand Tour du Sapenay",massif:"Chambotte",denivele:800,distance_km:13,duree_h:5,temps_voiture_min:80,difficulte:"Difficile",paysage:"Panorama",depart:"Saint-Germain-la-Chambotte"},
  {nom:"Le Mont du Chat (1504 m)",massif:"Épine",denivele:900,distance_km:11,duree_h:5,temps_voiture_min:85,difficulte:"Difficile",paysage:"Panorama",depart:"Bourdeau"},
  {nom:"Le Molard Noir par la Dent du Chat",massif:"Épine",denivele:1000,distance_km:13,duree_h:5.5,temps_voiture_min:85,difficulte:"Difficile",paysage:"Panorama",depart:"Le Bourget-du-Lac"},
  {nom:"Le Mont Grelle",massif:"Épine",denivele:900,distance_km:12,duree_h:5,temps_voiture_min:90,difficulte:"Difficile",paysage:"Sommet",depart:"Saint-Jean-de-Chevelu"},
  {nom:"Le Signal du Mont de l'Épine",massif:"Épine",denivele:600,distance_km:10,duree_h:4,temps_voiture_min:90,difficulte:"Moyen",paysage:"Forêt",depart:"Novalaise"},
  {nom:"La Montagne de Parménie",massif:"Terres Froides",denivele:500,distance_km:10,duree_h:4,temps_voiture_min:135,difficulte:"Moyen",paysage:"Panorama",depart:"Beaucroissant"},
  {nom:"Les Étangs de Bonnevaux",massif:"Terres Froides",denivele:300,distance_km:12,duree_h:4,temps_voiture_min:135,difficulte:"Moyen",paysage:"Étang",depart:"Villeneuve-de-Marc"},
  {nom:"Le Tour du Lac de Paladru par les collines",massif:"Terres Froides",denivele:400,distance_km:14,duree_h:4.5,temps_voiture_min:130,difficulte:"Moyen",paysage:"Lac",depart:"Charavines"},
  {nom:"Grande traversée des crêtes de Chambaran",massif:"Terres Froides",denivele:700,distance_km:18,duree_h:6,temps_voiture_min:140,difficulte:"Difficile",paysage:"Forêt",depart:"Roybon"},
  {nom:"La Roche Parnal",massif:"Bornes",denivele:1000,distance_km:11,duree_h:5.5,temps_voiture_min:95,difficulte:"Difficile",paysage:"Sommet",depart:"Le Petit-Bornand-les-Glières"},
  ...
  // ── 14ᵉ série : VANOISE (moyennes & difficiles, journée + 2 jours refuge) ──
  {nom:"Le Lac des Vaches & le Lac Long",massif:"Vanoise",denivele:700,distance_km:12,duree_h:5,temps_voiture_min:150,difficulte:"Moyen",paysage:"Lac",depart:"Pralognan-la-Vanoise"},
  {nom:"Le Plan du Lac & balcon de la Grande Casse",massif:"Vanoise",denivele:400,distance_km:9,duree_h:3.5,temps_voiture_min:150,difficulte:"Moyen",paysage:"Panorama",depart:"Termignon (Bellecombe)"},
  {nom:"Les Lacs Merlet",massif:"Vanoise",denivele:700,distance_km:11,duree_h:5,temps_voiture_min:150,difficulte:"Moyen",paysage:"Lac",depart:"Pralognan (Les Prioux)"},
  {nom:"Le Lac de l'Arpont",massif:"Vanoise",denivele:800,distance_km:14,duree_h:5.5,temps_voiture_min:150,difficulte:"Moyen",paysage:"Lac",depart:"Termignon"},
  {nom:"Le Col du Palet & Pointe du Chardonnet",massif:"Vanoise",denivele:1100,distance_km:16,duree_h:6.5,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Peisey-Nancroix (Rosuel)"},
  {nom:"Le Col d'Aussois & Pointe de l'Échelle",massif:"Vanoise",denivele:1000,distance_km:13,duree_h:6,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Aussois (Fournache)"},
  {nom:"Le Grand Roc Noir",massif:"Vanoise",denivele:1500,distance_km:16,duree_h:8,temps_voiture_min:155,difficulte:"Très difficile",paysage:"Sommet",depart:"Termignon"},
  {nom:"Col de la Vanoise & Refuge Félix Faure",massif:"Vanoise",denivele:1000,distance_km:20,duree_h:9,temps_voiture_min:150,difficulte:"Moyen",paysage:"Lac",depart:"Pralognan-la-Vanoise",jours:2,refuge:"Refuge du Col de la Vanoise (Félix Faure)"},
  {nom:"Tour des Glaciers : Refuge de l'Arpont",massif:"Vanoise",denivele:1100,distance_km:22,duree_h:10,temps_voiture_min:150,difficulte:"Difficile",paysage:"Glacier",depart:"Termignon",jours:2,refuge:"Refuge de l'Arpont"},
  {nom:"Refuge de Péclet-Polset & Col du Soufre",massif:"Vanoise",denivele:1200,distance_km:20,duree_h:10,temps_voiture_min:150,difficulte:"Difficile",paysage:"Glacier",depart:"Pralognan (Les Prioux)",jours:2,refuge:"Refuge de Péclet-Polset"},
  {nom:"Refuge de la Valette par le cirque du Grand Marchet",massif:"Vanoise",denivele:1300,distance_km:18,duree_h:10,temps_voiture_min:150,difficulte:"Difficile",paysage:"Sommet",depart:"Pralognan-la-Vanoise",jours:2,refuge:"Refuge de la Valette"},
  // ── 15ᵉ série : ajouts ──
  {nom:"L'Aiguille de la Grande Sassière (3747 m)",massif:"Vanoise",denivele:1200,distance_km:13,duree_h:7,temps_voiture_min:165,difficulte:"Très difficile",paysage:"Sommet",depart:"Tignes (Barrage de la Sassière / Le Saut)"},
  {nom:"Le Lac & la Réserve de la Grande Sassière",massif:"Vanoise",denivele:350,distance_km:9,duree_h:3.5,temps_voiture_min:165,difficulte:"Moyen",paysage:"Lac",depart:"Tignes (Le Saut)"},
  {nom:"La Jonction (glacier des Bossons)",massif:"Mont-Blanc",denivele:1500,distance_km:12,duree_h:7.5,temps_voiture_min:150,difficulte:"Très difficile",paysage:"Glacier",depart:"Les Bossons (Chamonix)"},
  {nom:"Les Lacs Robert",massif:"Belledonne",denivele:600,distance_km:10,duree_h:4,temps_voiture_min:150,difficulte:"Moyen",paysage:"Lac",depart:"Chamrousse (Recoin)"},
  {nom:"Le Lac Achard",massif:"Belledonne",denivele:350,distance_km:7,duree_h:3,temps_voiture_min:150,difficulte:"Facile",paysage:"Lac",depart:"Chamrousse (Recoin)"},
  {nom:"Les Lacs des Pourettes & Lac Achard",massif:"Belledonne",denivele:550,distance_km:10,duree_h:4,temps_voiture_min:150,difficulte:"Moyen",paysage:"Lac",depart:"Chamrousse (Recoin)"},
  // ── 16ᵉ série : SUD / autour de FRÉJUS (débutant, panoramas ; temps de route DEPUIS FRÉJUS) ──
  {nom:"Le Pic du Cap Roux",massif:"Estérel",denivele:350,distance_km:7,duree_h:2.5,temps_voiture_min:25,difficulte:"Moyen",paysage:"Panorama",depart:"Agay (Saint-Raphaël)"},
  {nom:"Le Mont Vinaigre (point culminant de l'Estérel)",massif:"Estérel",denivele:300,distance_km:7,duree_h:3,temps_voiture_min:30,difficulte:"Moyen",paysage:"Panorama",depart:"Fréjus (Le Malpey)"},
  {nom:"Le Cap Dramont, l'Île d'Or & le sémaphore",massif:"Estérel",denivele:150,distance_km:6,duree_h:2,temps_voiture_min:15,difficulte:"Facile",paysage:"Mer",depart:"Le Dramont (Saint-Raphaël)"},
  {nom:"Le Pic de l'Ours & la Corniche d'Or",massif:"Estérel",denivele:400,distance_km:9,duree_h:3.5,temps_voiture_min:35,difficulte:"Moyen",paysage:"Panorama",depart:"Le Trayas / Agay"},
  {nom:"Le Rocher de Roquebrune",massif:"Estérel",denivele:350,distance_km:7,duree_h:3,temps_voiture_min:20,difficulte:"Moyen",paysage:"Panorama",depart:"Roquebrune-sur-Argens"},
  {nom:"Notre-Dame-des-Anges (point culminant des Maures)",massif:"Maures",denivele:300,distance_km:9,duree_h:3.5,temps_voiture_min:55,difficulte:"Moyen",paysage:"Panorama",depart:"Gonfaron"},
  {nom:"Le Baou de Saint-Jeannet",massif:"Préalpes d'Azur",denivele:400,distance_km:7,duree_h:3,temps_voiture_min:85,difficulte:"Moyen",paysage:"Panorama",depart:"Saint-Jeannet"},
  {nom:"Le Saint-Pilon (Massif de la Sainte-Baume)",massif:"Sainte-Baume",denivele:450,distance_km:9,duree_h:3.5,temps_voiture_min:100,difficulte:"Moyen",paysage:"Panorama",depart:"Plan-d'Aups-Sainte-Baume"},
  {nom:"Les Belvédères du Grand Canyon du Verdon (Point Sublime)",massif:"Verdon",denivele:300,distance_km:8,duree_h:3,temps_voiture_min:105,difficulte:"Moyen",paysage:"Gorges",depart:"Rougon"},
  {nom:"Le Pic de Courmettes & le Puy de Tourrettes",massif:"Préalpes d'Azur",denivele:500,distance_km:10,duree_h:4,temps_voiture_min:95,difficulte:"Moyen",paysage:"Panorama",depart:"Tourrettes-sur-Loup"},
  // ── 17ᵉ série : secteur de BISE / Vallée d'Abondance (Chablais) ──
  {nom:"Les Cornettes de Bise en boucle",massif:"Chablais",denivele:1250,distance_km:14,duree_h:7,temps_voiture_min:135,difficulte:"Difficile",paysage:"Sommet",depart:"La Chapelle-d'Abondance (Bise)"},
  {nom:"Le Col d'Ugeon",massif:"Chablais",denivele:700,distance_km:11,duree_h:4,temps_voiture_min:135,difficulte:"Moyen",paysage:"Panorama",depart:"La Chapelle-d'Abondance (Bise)"},
  {nom:"La Dent du Velan",massif:"Chablais",denivele:900,distance_km:11,duree_h:5,temps_voiture_min:135,difficulte:"Difficile",paysage:"Sommet",depart:"La Chapelle-d'Abondance"},
  {nom:"Les Têtes de Charousse",massif:"Chablais",denivele:600,distance_km:10,duree_h:4,temps_voiture_min:135,difficulte:"Moyen",paysage:"Panorama",depart:"Vacheresse (Ubine)"},
  {nom:"Le Col de Bise",massif:"Chablais",denivele:650,distance_km:10,duree_h:4,temps_voiture_min:135,difficulte:"Moyen",paysage:"Panorama",depart:"La Chapelle-d'Abondance (Bise)"},
  // ── 18ᵉ série : SUD, moyennes avec panorama (temps depuis Fréjus) ──
  {nom:"Le Pic d'Aurelle",massif:"Estérel",denivele:350,distance_km:8,duree_h:3,temps_voiture_min:30,difficulte:"Moyen",paysage:"Mer",depart:"Anthéor (Saint-Raphaël)"},
  {nom:"Le Pic du Perthus & le Sommet Pelet",massif:"Estérel",denivele:450,distance_km:10,duree_h:3.5,temps_voiture_min:35,difficulte:"Moyen",paysage:"Panorama",depart:"Le Trayas"},
  {nom:"Le Cap Lardier & le Cap Taillat",massif:"Maures",denivele:300,distance_km:12,duree_h:4,temps_voiture_min:60,difficulte:"Moyen",paysage:"Mer",depart:"La Croix-Valmer (Gigaro)"},
  {nom:"Le Fenouillet (balcon des îles d'Hyères)",massif:"Maures",denivele:300,distance_km:8,duree_h:3,temps_voiture_min:85,difficulte:"Moyen",paysage:"Mer",depart:"Hyères"},
  {nom:"Notre-Dame-du-Mai (Cap Sicié)",massif:"Maures",denivele:300,distance_km:8,duree_h:3,temps_voiture_min:100,difficulte:"Moyen",paysage:"Mer",depart:"Six-Fours-les-Plages"},
  {nom:"Le Pic de Bertagne",massif:"Sainte-Baume",denivele:600,distance_km:11,duree_h:4.5,temps_voiture_min:110,difficulte:"Moyen",paysage:"Panorama",depart:"Plan-d'Aups-Sainte-Baume"},
  {nom:"La Crête de la Sainte-Baume (Signal des Béguines)",massif:"Sainte-Baume",denivele:500,distance_km:12,duree_h:4.5,temps_voiture_min:105,difficulte:"Moyen",paysage:"Panorama",depart:"Plan-d'Aups-Sainte-Baume"},
  {nom:"La Montagne du Cheiron",massif:"Préalpes d'Azur",denivele:600,distance_km:12,duree_h:4.5,temps_voiture_min:95,difficulte:"Moyen",paysage:"Panorama",depart:"Gréolières"},
  {nom:"Le Sommet du Robion (balcon du Verdon)",massif:"Verdon",denivele:550,distance_km:11,duree_h:4,temps_voiture_min:100,difficulte:"Moyen",paysage:"Panorama",depart:"Castellane"},
  {nom:"Moustiers-Sainte-Marie & Notre-Dame-de-Beauvoir",massif:"Verdon",denivele:300,distance_km:6,duree_h:2.5,temps_voiture_min:105,difficulte:"Moyen",paysage:"Panorama",depart:"Moustiers-Sainte-Marie"}
];
...
const isBivouac = r => r.jours===2 || !!r.refuge;
function randoChips(r){
  const c=[];
  if(isBivouac(r))              c.push(`<span class="chip chip-biv">🏕️ 2 jours${r.refuge?' · '+esc(r.refuge):''}</span>`);
...
function renderHome(){
  ...
  $('view-home').innerHTML=`
    ...
    ${bdayHtml}
    <div class="stats">
      <div class="stat" onclick="navigate('randos')"><div class="v">${arr(CACHE.randos).length}</div><div class="l">Randos ›</div></div>
      <div class="stat" onclick="navigate('membres')"><div class="v">${arr(CACHE.membres).length}</div><div class="l">La Team ›</div></div>
      <div class="stat" onclick="goMesFaites()"><div class="v">${arr(CACHE.faites).filter(f=>f.membreId===ME.id).length}</div><div class="l">Mes faites ›</div></div>
    </div>
...
function renderRandos(){
  ...
  $('view-randos').innerHTML=`
    ...
    <div class="filters">
      ...
      <span class="fchip ${RF.done?'on':''}" onclick="toggleRF('done')">✅ Mes faites</span>
      <span class="fchip ${RF.type==='jour'?'on':''}" onclick="setRF('type','${RF.type==='jour'?'':'jour'}')">☀️ Journée</span>
      <span class="fchip ${RF.type==='bivouac'?'on':''}" onclick="setRF('type','${RF.type==='bivouac'?'':'bivouac'}')">🏕️ Bivouac 2j</span>
...
function openCarteMassifs(){
  // Chaque massif = une zone délimitée par une frontière ORGANIQUE (Voronoï + bords ondulés partagés)
  const X0=12,Y0=12,X1=708,Y1=588;
  const clip=(poly,nx,ny,C)=>{ const out=[]; const N=poly.length; for(let k=0;k<N;k++){ const A=poly[k],B=poly[(k+1)%N];
    const fa=nx*A[0]+ny*A[1]-C, fb=nx*B[0]+ny*B[1]-C; const inA=fa<=1e-7, inB=fb<=1e-7;
    if(inA)out.push(A); if(inA!==inB){ const t=fa/(fa-fb); out.push([A[0]+t*(B[0]-A[0]),A[1]+t*(B[1]-A[1])]); } } return out; };
  const hsh=s=>{ let x=2166136261; for(let i=0;i<s.length;i++){ x^=s.charCodeAt(i); x=Math.imul(x,16777619); } return (x>>>0); };
  const off=(P,Q)=>{ const a=Math.round(P[0])+','+Math.round(P[1]), b=Math.round(Q[0])+','+Math.round(Q[1]);
    const key=a<b?a+'|'+b:b+'|'+a; return ((hsh(key)%1000)/1000-0.5)*2; };
  const onFrame=(A,B)=>(Math.abs(A[0]-X0)<0.6&&Math.abs(B[0]-X0)<0.6)||(Math.abs(A[0]-X1)<0.6&&Math.abs(B[0]-X1)<0.6)||(Math.abs(A[1]-Y0)<0.6&&Math.abs(B[1]-Y0)<0.6)||(Math.abs(A[1]-Y1)<0.6&&Math.abs(B[1]-Y1)<0.6);
  const wavy=poly=>{ const n=poly.length; let d='';
    for(let k=0;k<n;k++){ const A=poly[k],B=poly[(k+1)%n];
      if(k===0) d+='M'+A[0].toFixed(1)+' '+A[1].toFixed(1);
      if(onFrame(A,B)){ d+=' L'+B[0].toFixed(1)+' '+B[1].toFixed(1); continue; }
      let P=A,Q=B; if(P[0]>Q[0]||(P[0]===Q[0]&&P[1]>Q[1])){ P=B; Q=A; }
      const mx=(P[0]+Q[0])/2,my=(P[1]+Q[1])/2, dx=Q[0]-P[0],dy=Q[1]-P[1], len=Math.hypot(dx,dy)||1;
      const amp=Math.min(len*0.16,15), o=off(P,Q)*amp, cx=mx-dy/len*o, cy=my+dx/len*o;
      d+=' Q'+cx.toFixed(1)+' '+cy.toFixed(1)+' '+B[0].toFixed(1)+' '+B[1].toFixed(1); }
    return d+'Z'; };
  const zones=CARTE_MASSIFS.map((m,i)=>{ let poly=[[X0,Y0],[X1,Y0],[X1,Y1],[X0,Y1]];
    for(let j=0;j<CARTE_MASSIFS.length && poly.length;j++){ if(j===i)continue; const o=CARTE_MASSIFS[j];
      const nx=o.x-m.x, ny=o.y-m.y, C=nx*(m.x+o.x)/2+ny*(m.y+o.y)/2; poly=clip(poly,nx,ny,C); }
    if(!poly.length) return '';
    return `<path d="${wavy(poly)}" fill="#8fb15c" stroke="#4f5f34" stroke-width="1.2" stroke-linejoin="round"/>`; }).join('');
  const relief=`<g opacity="0.5">
    <ellipse cx="470" cy="300" rx="150" ry="130" fill="#7d9c4d"/><ellipse cx="580" cy="380" rx="120" ry="140" fill="#6f8f42"/>
    <ellipse cx="600" cy="300" rx="70" ry="70" fill="#647f3a"/><ellipse cx="360" cy="430" rx="120" ry="95" fill="#7d9c4d"/>
    <ellipse cx="300" cy="200" rx="90" ry="80" fill="#82a350"/><ellipse cx="200" cy="470" rx="90" ry="90" fill="#82a350"/></g>`;
  const snow=`<path d="M600 306 l14 -24 l14 24 z" fill="#f4f7ef"/><path d="M579 452 l12 -20 l12 20 z" fill="#f4f7ef"/>`;
  const lakes=`
    <path d="M352 78 Q 420 58 486 78 Q 470 96 410 96 Q 366 94 352 78 Z" fill="#8fbcd8" stroke="#5f8fb0" stroke-width="1"/>
    <ellipse cx="256" cy="388" rx="9" ry="24" fill="#8fbcd8" stroke="#5f8fb0" stroke-width="1"/>
    <ellipse cx="360" cy="300" rx="7" ry="17" fill="#8fbcd8" stroke="#5f8fb0" stroke-width="1" transform="rotate(28 360 300)"/>`;
  const labels=CARTE_MASSIFS.map(m=>`<text x="${m.x}" y="${m.y+4}" text-anchor="middle" font-size="${m.n.length>9?11:12}" font-weight="800" fill="#243310" letter-spacing="0.4" paint-order="stroke" stroke="#e7efce" stroke-width="2.4">${esc(m.n.toUpperCase())}</text>`).join('');
  const villes=CARTE_VILLES.map(v=>{
    if(v.star) return `<g><text x="${v.x}" y="${v.y+7}" text-anchor="middle" font-size="22">📍</text>
      <text x="${v.x}" y="${v.y-13}" text-anchor="middle" font-size="12.5" font-weight="800" fill="#14210a" paint-order="stroke" stroke="#fff" stroke-width="3">Nantua</text></g>`;
    const edge=v.x>560; const tx=edge?v.x-8:v.x+8; const anchor=edge?'end':'start';
    return `<g><circle cx="${v.x}" cy="${v.y}" r="3.2" fill="#1a1a1a" stroke="#fff" stroke-width="1.3"/>
      <text x="${tx}" y="${v.y+4}" text-anchor="${anchor}" font-size="11.5" font-weight="700" fill="#1a1a1a" paint-order="stroke" stroke="#fff" stroke-width="2.4">${esc(v.n)}</text></g>`; }).join('');
  const svg=`<svg viewBox="0 0 720 600" width="100%" style="display:block;border-radius:16px;border:2px solid #b9c0a0;background:#eef1e2">
    <defs><clipPath id="land">${CARTE_MASSIFS.map((m,i)=>{ let poly=[[X0,Y0],[X1,Y0],[X1,Y1],[X0,Y1]];
      for(let j=0;j<CARTE_MASSIFS.length && poly.length;j++){ if(j===i)continue; const o=CARTE_MASSIFS[j]; const nx=o.x-m.x, ny=o.y-m.y, C=nx*(m.x+o.x)/2+ny*(m.y+o.y)/2; poly=clip(poly,nx,ny,C); }
      return poly.length?`<path d="${wavy(poly)}"/>`:''; }).join('')}</clipPath></defs>
    ${zones}
    <g clip-path="url(#land)">${relief}</g>
    ${snow}${lakes}${villes}${labels}
  </svg>`;
...
function toggleRF(k){ if(RF[k])delete RF[k]; else { RF[k]=1; if(k==='todo')delete RF.done; if(k==='done')delete RF.todo; } renderRandos(); }
...
function drawRandos(){
  ...
  if(nearMode){
    ...
    if(RF.done) list=list.filter(r=>iDid(r.id));
    if(RF.type==='bivouac') list=list.filter(isBivouac); else if(RF.type==='jour') list=list.filter(r=>!isBivouac(r));
  ...
  el.innerHTML=list.length?count+list.map(r=>{
    ...
    return `<div class="rando${isBivouac(r)?' bivouac':''}" onclick="openRando('${r.id}')">
...
function openRando(id){
  ...
  openModal(`
    ...
    <div class="chips" style="margin-top:14px">
      ${iDid(id)?`<button class="btn btn-ghost btn-sm" onclick="retirerFaite('${id}')">✗ Je ne l'ai plus faite</button><button class="btn btn-soft btn-sm" onclick="openRessenti('${id}')">💬 Mon avis</button>`:`<button class="btn btn-sm" onclick="openMarquerFaite('${id}')">✅ Je l'ai faite !</button>`}
...
function openMarquerFaite(id){
  ...
  openModal(`<h3>✅ ${esc(r.nom)}</h3>
    ...
    <div class="fg"><label>Ton avis (plusieurs choix possibles)</label><div id="ress-chips" class="filters" style="margin:0 -4px;border:none;padding:0">${ressChipsHtml()}</div></div>
...
function openRessenti(id){
  ...
  openModal(`<h3>💬 Mon avis · ${esc(r.nom)}</h3>
...
async function saveRessenti(id,fid){ await DB.update('faites/'+fid,{ressenti:_mfRess.slice()}); toast('Avis enregistré 💬'); openRando(id); }
